...
public class Constants {
    ...
    public static final String [] FILTER_OPTION={"Color shift right filter","Color shift left filter","Sepia filter",
            "Black and white filter","Negative filter","Mirror filter"};
